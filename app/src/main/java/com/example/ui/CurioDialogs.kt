...
fun BulkCategoryDialog(
    ...
    val categories = listOf("Work", "Personal", "Reading List", "Development", "Design", "Marketing", "Crypto", "Business", "Life")
    SlideUpCard(
        onDismissRequest = onDismissRequest,
        tier = tier,
        verticalArrangement = Arrangement.spacedBy(16.dp),
                        ...
                        Box(
                            ...
                            Row(
                                ...
                                Box(
                                    modifier = Modifier
                                        .size(10.dp)
                                        .background(getCategoryColor(cat), RoundedCornerShape(5.dp))
                                )
                                Text(
                                    text = cat.uppercase(),
                                    style = MaterialTheme.typography.labelMedium.copy(
